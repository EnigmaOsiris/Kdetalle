...
/**
 * Tarjeta de producto para mostrar en el catálogo
 */
    ...
    <div className="card hover:shadow-lg transition-shadow cursor-pointer">
      <div onClick={onViewDetails}>
        ...
        <div className="p-4">
          ...
          {/* Preview de tallas disponibles */}
          {product.tallas && product.tallas.length > 0 && (
            <div className="mb-2">
              <p className="text-sm text-gray-600 mb-1">Tallas:</p>
              <div className="flex flex-wrap gap-1">
                {product.tallas.slice(0, 5).map((talla, index) => (
                  <span
                    key={index}
      ...
      <div className="p-4 pt-0 flex gap-2">
        ...
        <button
          ...
          className="flex-1 btn-whatsapp text-sm"
        >
          <svg
            className="w-5 h-5"
            fill="currentColor"
